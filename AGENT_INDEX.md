...
5. Add `harness:refactor` as a structural triage overlay for cross-layer changes, file moves, ownership changes, or drifting boundaries. The current MVP has three primary boundaries: popup UI, storage/filesystem adapters, and metadata/naming domain logic.
...
- For this repository, the first implementation loop should keep write scope inside extension source, docs, and verification artifacts.
